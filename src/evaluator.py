...
def _generate_text_report(
    ...
    # 生成Markdown报告
    md_path = out_dir / "metrics" /f"{prefix}_report.md"
    txt_path = out_dir / "metrics" /f"{prefix}_report.txt"
...
def _maybe_plot(
    ...
    try:
        ...
        plt.tight_layout()
        plot_file = out_dir / "visualizations" /f"{prefix}_gap_hist.png"
    ...
    try:
        ...
        ax.grid(True, alpha=0.3)
        plt.tight_layout()
        plot_file = out_dir / "visualizations" / f"{prefix}_s1_vs_s2_scatter.png"
        plt.savefig(plot_file, dpi=150, bbox_inches='tight')
    ...
    try:
        ...
        plt.tight_layout()
        plot_file = out_dir / "visualizations" /f"{prefix}_s1_s2_boxplot.png"
        plt.savefig(plot_file, dpi=150, bbox_inches='tight')
    ...
    try:
        ...
        ax.grid(True, alpha=0.3, axis='y')
        plt.tight_layout()
        plot_file = out_dir / "visualizations" /f"{prefix}_violin.png"
        plt.savefig(plot_file, dpi=150, bbox_inches='tight')
    ...
    if rows_data and 'gt_offset' in rows_data[0]:
        try:
            ...
            ax.grid(True, alpha=0.3)
            plt.tight_layout()
            plot_file = out_dir / "visualizations" /f"{prefix}_gap_vs_gt.png"
            plt.savefig(plot_file, dpi=150, bbox_inches='tight')
    ...
    try:
        ...
        ax.grid(True, alpha=0.3)
        plt.tight_layout()
        plot_file = out_dir / "visualizations" /f"{prefix}_cdf.png"
        plt.savefig(plot_file, dpi=150, bbox_inches='tight')
    ...
    if rows_data and 'gt_score_mapped' in rows_data[0]:
        try:
            ...
            ax.grid(True, alpha=0.3)
            plt.tight_layout()
            plot_file = out_dir /"visualizations" / f"{prefix}_s2_vs_gt.png"
            plt.savefig(plot_file, dpi=150, bbox_inches='tight')
